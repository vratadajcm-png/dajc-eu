...
import {canonicalDrivingBans, getDrivingBansSnapshot, drivingBanScope} from '../config/driving-ban-calendars/runtime.mjs';
const files = ['src/lib/driving-bans/core.mjs','config/driving-ban-calendars/canonical.mjs','config/driving-ban-calendars/index.mjs','config/driving-ban-calendars/runtime.mjs','config/driving-ban-calendars/scope.mjs','tests/driving-bans-cases.mjs','tests/driving-bans-production-cases.mjs','tests/run-driving-bans.mjs','scripts/lint-driving-bans.mjs','scripts/audit-driving-bans.mjs'];
...
assert.equal(getDrivingBansSnapshot().jurisdictions.length,drivingBanScope.length);
