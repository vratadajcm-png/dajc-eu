...
export const currentDrivingBanExceptions = [
  ...
  },
  {
    ...
    routeScope: 'A1 Zagreb–Split–Dubrovnik near Lučko, Split and Bisko; A3 Bregana–Lipovac near Sveta Nedelja/Zagreb zapad and Okučani; A4 Goričan–Zagreb near Varaždin; A6 Rijeka–Zagreb from ČCNP Rijeka to Kikovica, depending on date.',
        ...
        occurrences: [
          {
            ...
            whatChanged: 'HAK confirms repeated September night stoppages for extraordinary-transport movements on A1 and A3.',
            validFrom: '2026-09-05',
            validTo: '2026-09-14',
            timeWindow: 'Through 14 September 2026, 23:00–05:00; A1 near Lučko and Split and A3 in the roadworks zone between Sveta Nedelja and Zagreb zapad. Traffic may be stopped several times for up to 15 minutes.',
          ...
          },
          {
            ...
            whatChanged: 'HAK continues repeated temporary suspensions near the Bisko junction for extraordinary-transport movements.',
            validFrom: '2026-09-05',
            validTo: '2026-09-30',
            timeWindow: 'Through 30 September 2026, 22:00–05:00; traffic may be suspended repeatedly for up to 15 minutes near the Bisko junction in both directions.',
          ...
          {
            title: 'One-night extraordinary-transport stoppage — A4 Varaždin',
            whatChanged: 'HAK lists one remaining night window through 9 September for an extraordinary transport entering A4 at Varaždin toward Goričan.',
            validFrom: '2026-09-08',
            validTo: '2026-09-09',
            timeWindow: 'One night through 9 September 2026, 23:00–05:00; traffic may be stopped once for up to 15 minutes at Varaždin junction toward Goričan.',
            impact: 'A short closure can affect HGV and exceptional-transport timing on A4.',
            recommendedAction: 'Check live HAK status before entering A4 at Varaždin during the night window.',
          },
          {
            title: 'Extraordinary-transport stoppage — A3 Okučani',
            whatChanged: 'HAK added a new mid-September window for an extraordinary transport leaving the A3 main carriageway at Okučani.',
            validFrom: '2026-09-15',
            validTo: '2026-09-24',
            timeWindow: '15–24 September 2026, 23:00–05:00; one traffic stop of up to 15 minutes at Okučani junction in both directions.',
            impact: 'A short full traffic stop may delay HGV movements and affect convoy/permit timing on A3.',
            recommendedAction: 'Build a timing margin into A3 movements and verify HAK immediately before departure.',
          },
          {
            title: 'Extraordinary-transport stoppages — A6 Rijeka–Kikovica',
            whatChanged: 'HAK added three night windows through the end of September for extraordinary transports on A6 between ČCNP Rijeka and Kikovica.',
            validFrom: '2026-09-08',
            validTo: '2026-09-30',
            timeWindow: 'Three night periods through 30 September 2026, 00:00–04:00; traffic may be temporarily stopped for up to 15 minutes between ČCNP Rijeka and Kikovica (D3 interchange) in both directions.',
            impact: 'Short closures can delay night HGV traffic and are operationally relevant to oversize permit and escort timing on the Rijeka corridor.',
            recommendedAction: 'Verify the live HAK report before any night movement on A6 and keep contingency time in the route plan.',
          },
        ],
      };
    },
